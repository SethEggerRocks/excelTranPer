...
def glcNumbers():
    ...
    print("Graduated percentage for GLC:" + str(len(glc_completedList)/len(glc_emptyList)))

    for i in glc_emptyList:
        if i == "Discharged":
            glc_dischargedList.append(i)
    print("Discharged percentage for GLC:" + str(len(glc_dischargedList)/len(glc_emptyList)))
...
def doughertyNumbers():
    ...
    print("Graduated percentage for IOP:" + str(len(do_completedList)/len(do_emptyList)))

    for i in do_emptyList:
        if i == "Unsucc":
            do_dischargedList.append(i)
    print("Unsuccessful percentage for IOP:" + str(len(do_dischargedList)/len(do_emptyList)))
...
def droegeNumbers():
    ...
    for i in dr_emptyList:
        if i == "ASA":
            dr_asaList.append(i)
    print("ASA percentage for Droege:" + str(len(dr_asaList)/len(dr_emptyList)))

    for i in dr_emptyList:
        if i == "Graduate":
            dr_completedList.append(i)
    print("Graduated percentage for Droege:" + str(len(dr_completedList)/len(dr_emptyList)))

    for i in dr_emptyList:
        if i == "Complete":
            dr_arrestedList.append(i)
    print("Completion percentage for Droege:" + str(len(dr_arrestedList)/len(dr_emptyList)))

    for i in dr_emptyList:
        if i == "Discharged":
            dr_dischargedList.append(i)
    print("Discharged percentage for Droege:" + str(len(dr_dischargedList)/len(dr_emptyList)))
...
def detoxNumbers():
    ...
    for i in de_emptyList:
        if i == "ASA":
            de_asaList.append(i)
    print("ASA percentage for Detox:" + str(len(de_asaList) / len(de_emptyList)))

    for i in de_emptyList:
        if i == "Med Discharge":
            de_completedList.append(i)
    print("MEd Discharge percentage for Detox:" + str(len(de_completedList) / len(de_emptyList)))

    for i in de_emptyList:
        if i == "comp":
            de_arrestedList.append(i)
    print("Completion percentage for Detox:" + str(len(de_arrestedList) / len(de_emptyList)))

    for i in de_emptyList:
        if i == "Discharged":
            de_dischargedList.append(i)
    print("Discharged percentage for Detox:" + str(len(de_dischargedList) / len(de_emptyList)))
...
def wrapNumbers():
    ...
    for i in emptyList:
        if i == "ASA":
            asaList.append(i)
    print("ASA percentage for WRAP:" + str(len(asaList)/len(emptyList)))

    for i in emptyList:
        if i == "Completed":
            completedList.append(i)
    print("Completed percentage for WRAP:" + str(len(completedList)/len(emptyList)))

    for i in emptyList:
        if i == "Arrested":
            arrestedList.append(i)
    print("Arrested percentage for WRAP:" + str(len(arrestedList)/len(emptyList)))

    for i in emptyList:
        if i == "Discharged":
            dischargedList.append(i)
    print("Discharged percentage for WRAP:" + str(len(dischargedList)/len(emptyList)))
